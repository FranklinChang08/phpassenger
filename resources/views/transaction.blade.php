<x-main-layout title="Jadwal">
    ...
    @section('content')
        <section>
                ...
                <div class="col-span-2 bg-white w-full rounded-lg p-4">
                    ...
                    <div class="flex flex-col gap-4">
                        ...
                        <div class="form mt-6">
                            ...
                            <form action="{{ route('transaction.updateCustomer') }}" class="w-full bg-white p-4 rounded-lg"
            ...
            <form action="{{ route('transaction.cancelCustomer', $id_pemesanan) }}" method="POST"
