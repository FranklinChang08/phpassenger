<x-admin-layout>
    <div class="kelasList">
        <div
            ...
            <h1 class="text-gray-800 font-bold">Kelas List</h1>
        ...
        <div class="flex items-center gap-6 my-4">
            <button onclick="togglePartial()" class="font-bold bg-blue-600 px-4 py-2 rounded-md text-white">Tambah
                Form</button>
            <form action="{{ route('kelas.index') }}" method="GET" class="flex items-center rounded-lg gap-2">
        ...
        <table class="table-auto w-full mt-4 bg-white rounded-lg shadow-md overflow-hidden">
            <thead class="bg-gray-100">
                <tr class="text-left">
                    ...
                    <th class="px-4 py-2 border-b font-bold text-gray-800">Nama Kelas</th>
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-3 border-b text-gray-700">
                                ...
                                <form action="{{ route('kelas.destroy', $data->id_kelas) }}" method="POST"
                                    class="inline-block" onsubmit="return confirm('Yakin ingin menghapus kelas ini?')">
                                    @csrf
                                    @method('DELETE')
