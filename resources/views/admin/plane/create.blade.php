<x-admin-layout>
    <div
        ...
        <h1 class="text-gray-800 font-bold">Create Bus</h1>
    ...
    <form action="{{ route('plane.store') }}" method="POST"
        ...
        <div>
            ...
            <input type="text" name="nama_maskapai" id="nama_maskapai" value="{{ old('nama_maskapai') }}" required
        ...
        <div>
            ...
            <input type="text" name="nomor_regis" id="nomor_regis" value="{{ old('nomor_regis') }}"
                class="mt-1 w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
            @error('nomor_regis')
                <span class="text-red-500 text-sm">{{ $message }}</span>
            @enderror
        ...
        <div>
            ...
            <input type="text" name="nomor_penerbangan" id="nomor_penerbangan" value="{{ old('nomor_penerbangan') }}"
                class="mt-1 w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
        ...
        <div>
            ...
            <input type="text" name="kapasitas" id="kapasitas" value="{{ old('kapasitas') }}"
                class="mt-1 w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
            @error('kapasitas')
                <span class="text-red-500 text-sm">{{ $message }}</span>
            @enderror
