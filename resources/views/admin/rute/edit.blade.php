<x-admin-layout>
    <div
        ...
        <h1 class="text-gray-800 font-bold">Edit Rute</h1>
    ...
    <form action="{{ route('rute.update', $rute->id_rute) }}" method="POST"
        ...
        <div>
            ...
            <input type="text" name="tujuan" id="tujuan" value="{{ old('tujuan', $rute->tujuan) }}"
                class="mt-1 w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
            @error('tujuan')
                <span class="text-red-500 text-sm">{{ $message }}</span>
            @enderror
        ...
        <div>
            ...
            <input type="text" name="jarak_km" id="jarak_km" value="{{ old('jarak_km', $rute->jarak_km) }}"
                class="mt-1 w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
            @error('jarak_km')
                <span class="text-red-500 text-sm">{{ $message }}</span>
            @enderror
